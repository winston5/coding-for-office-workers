...
class Article:
    ...
    def __init__(self, title, content): #init은 class 내장함수
        self.title = title #class 내 모든 함수는 self를 붙여줘야 함
...
class BrunchArticle(Article):
    ...
    def read(self):
        self.view_count = self.view_count + 2 #overrode the same function in parent function
